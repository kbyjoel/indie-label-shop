 ...
 */
final class Version20260214151336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aropixel_file (title VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) NOT NULL, extension VARCHAR(20) NOT NULL, public TINYINT NOT NULL, import LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE aropixel_image (title VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, attr_title VARCHAR(255) DEFAULT NULL, attr_alt VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) NOT NULL, width INT DEFAULT NULL, height INT DEFAULT NULL, extension VARCHAR(20) NOT NULL, import LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE indie_album (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, catalog_number VARCHAR(100) DEFAULT NULL, release_date DATE DEFAULT NULL, status VARCHAR(20) NOT NULL, band_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_9AF7069477153098 (code), INDEX IDX_9AF7069449ABEB17 (band_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE indie_album_channels (album_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_91E68C111137ABCF (album_id), INDEX IDX_91E68C1172F5A1AA (channel_id), PRIMARY KEY (album_id, channel_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE indie_release (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, position INT DEFAULT NULL, on_hold INT NOT NULL, on_hand INT NOT NULL, tracked TINYINT NOT NULL, version INT NOT NULL, title VARCHAR(255) NOT NULL, price NUMERIC(10, 2) NOT NULL, status VARCHAR(20) NOT NULL, product_id INT NOT NULL, media_id INT NOT NULL, UNIQUE INDEX UNIQ_13571AC077153098 (code), INDEX IDX_13571AC04584665A (product_id), INDEX IDX_13571AC0EA9FDD75 (media_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE indie_track (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, position INT DEFAULT NULL, on_hold INT NOT NULL, on_hand INT NOT NULL, tracked TINYINT NOT NULL, version INT NOT NULL, title VARCHAR(255) NOT NULL, duration VARCHAR(20) DEFAULT NULL, isrc VARCHAR(20) DEFAULT NULL, lyrics LONGTEXT DEFAULT NULL, product_id INT NOT NULL, UNIQUE INDEX UNIQ_758C907177153098 (code), INDEX IDX_758C90714584665A (product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE sylius_product (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_677B9B7477153098 (code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE indie_album ADD CONSTRAINT FK_9AF7069449ABEB17 FOREIGN KEY (band_id) REFERENCES indie_band (id)');
        $this->addSql('ALTER TABLE indie_album_channels ADD CONSTRAINT FK_91E68C111137ABCF FOREIGN KEY (album_id) REFERENCES indie_album (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE indie_album_channels ADD CONSTRAINT FK_91E68C1172F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE indie_release ADD CONSTRAINT FK_13571AC04584665A FOREIGN KEY (product_id) REFERENCES indie_album (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE indie_release ADD CONSTRAINT FK_13571AC0EA9FDD75 FOREIGN KEY (media_id) REFERENCES indie_media (id)');
        $this->addSql('ALTER TABLE indie_track ADD CONSTRAINT FK_758C90714584665A FOREIGN KEY (product_id) REFERENCES indie_album (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE indie_album DROP FOREIGN KEY FK_9AF7069449ABEB17');
        $this->addSql('ALTER TABLE indie_album_channels DROP FOREIGN KEY FK_91E68C111137ABCF');
        $this->addSql('ALTER TABLE indie_album_channels DROP FOREIGN KEY FK_91E68C1172F5A1AA');
        ...
        $this->addSql('ALTER TABLE indie_release DROP FOREIGN KEY FK_13571AC04584665A');
        $this->addSql('ALTER TABLE indie_release DROP FOREIGN KEY FK_13571AC0EA9FDD75');
        $this->addSql('ALTER TABLE indie_track DROP FOREIGN KEY FK_758C90714584665A');
        ...
        $this->addSql('DROP TABLE indie_album_channels');
